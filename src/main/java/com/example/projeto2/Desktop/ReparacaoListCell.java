...
public class ReparacaoListCell extends ListCell<Reparacao> {
    private final HBox hbox = new HBox(10);
    private final Label label = new Label();
    private final Button selectButton = new Button("Selecionar");
    private final ReparacaoModalController controller;

    public ReparacaoListCell(ReparacaoModalController controller) {
        super();
